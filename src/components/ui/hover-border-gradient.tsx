...
>) {
  ...
  const highlight =
    "radial-gradient(75% 181.15942028985506% at 50% 50%, #43FFFF 0%, rgba(255, 255, 255, 0) 100%)";
  ...
  return (
    ...
    >
      <div
        className={cn(
          "z-10 w-auto rounded-[inherit] bg-primary px-4 py-2 text-white",
          className,
        )}
      >
        {children}
      ...
      />
      <div className="z-1 absolute inset-[2px] flex-none rounded-[100px] bg-primary" />
    </Tag>
  );
}
